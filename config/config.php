...
# Default app settings
	if(!defined('APP_EMAIL')) define('APP_EMAIL', 'info@cbapro.biz'); # Should match domain name to avoid hitting the spam box
	if(!defined('APP_NAME')) define('APP_NAME', 'My App'); # Should match domain name to avoid hitting the spam box
	if(!defined('SYSTEM_EMAIL')) define('SYSTEM_EMAIL', 'help@cbapro.biz'); 
